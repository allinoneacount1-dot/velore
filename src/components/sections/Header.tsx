          ...
          <nav className="flex flex-col gap-4" aria-label="Mobile navigation">
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="rounded-xl px-4 py-3 text-sm font-medium text-[var(--fg-muted)] transition-all duration-200 hover:bg-[rgba(163,177,198,0.1)] hover:text-[var(--fg)] font-body"
              >
                {link.label}
              </a>
            ))}
